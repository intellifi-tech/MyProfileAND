...
namespace MyProfileAND.Favoriler.TakipEttiklerim.KisiBazliListe
{
    ...
    class KisiBazliListeRecyclerviewAdepter : RecyclerView.Adapter, View.IOnClickListener
    {
        private List<UserAttendedEvent> mData = new List<UserAttendedEvent>();
        AppCompatActivity BaseActivity;
        public event EventHandler<int> ItemClick;

        public KisiBazliListeRecyclerviewAdepter(List<UserAttendedEvent> GelenData, AppCompatActivity GelenContex)
        {
            mData = GelenData;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            return new TakipcilerRecyclerViewHolder(v, OnClick);
        }
